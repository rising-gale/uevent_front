                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-dark-blue-pastel outline-none focus:outline-none">
                    ...
                    <div className="relative p-4 flex flex-col">
                        <div className='pb-1 flex items-center w-full justify-between'>
                            <label className='text-2xl text-beige'>Title:</label>
                            <input type={"text"} className="focus:border-none w-2/3 rounded-full outline-none text-black px-2 py-1 " name='title' onChange={handleChange} />
                        </div>
                        <div className='py-1 flex items-center w-full justify-between'>
                            <label className='text-2xl text-beige'>Tickets:</label>
                            <input type={"number"} min={1} defaultValue={1} className="focus:border-none w-2/3  rounded-full outline-none text-black px-2 py-1" name='ticketsCount' onChange={handleChange} />
                        </div>
                        <div className='py-1 flex items-center w-full justify-between'>
                            <label className='text-2xl text-beige'>Category:</label>
