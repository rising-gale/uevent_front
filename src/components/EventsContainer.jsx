        ...
        <div className='p-1 flex flex-col bg-dark-purple text-light-beige '>
            ...
            <div className='flex w-full h-12 justify-around'>
                <div className='p-1 w-2/5 h-full flex items-center'>
                    <input autoComplete='off' type="text" name="search" className='w-5/6 text-base p-3 border-1 black rounded-lg h-full outline-none bg-light-beige text-black' placeholder='Input name of event ...' onChange={handleChange}/>
