...
const EventPicLoadForm = ({ data, closeForm }) => {
    ...
    return (
        <div className="text-white items-center justify-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-slate-600 bg-opacity-50">
